...
/* Enable ancestor support and initial transition support*/
 ...
 */
    ...
    #define SMF_STATE_PARENT(_parent) .parent = _parent,
#else
    #define SMF_STATE_PARENT(_parent)
#endif

#ifdef CONFIG_SMF_INITIAL_TRANSITION
    #define SMF_STATE_INITIAL(_initial) .initial = _initial,
#else
    #define SMF_STATE_INITIAL(_initial)
#endif
...
{                                                                  \
    ...
    .run     = _run,                                               \
    .exit    = _exit,                                              \
    SMF_STATE_PARENT(_parent)                                      \
    SMF_STATE_INITIAL(_initial)                                    \
}
